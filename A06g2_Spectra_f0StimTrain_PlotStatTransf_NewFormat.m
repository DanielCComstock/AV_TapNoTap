...
freqData = LM_Pow_2Bin;
save([savePath 'LM_Pow_2Bin'], 'freqData', 'freqs');

freqData = LM_Pow_2BinOff1;
save([savePath 'LM_Pow_2BinOff1'], 'freqData', 'freqs');

freqData = LM_Pow_2BinOff2;
save([savePath 'LM_Pow_2BinOff2'], 'freqData', 'freqs');

freqData = LM_Pow_3Bin;
save([savePath 'LM_Pow_3Bin'], 'freqData', 'freqs');

freqData = LM_Pow_3BinOff1;
save([savePath 'LM_Pow_3BinOff1'], 'freqData', 'freqs');

freqData = LM_Pow_Raw;
save([savePath 'uncorrected/' 'LM_Pow_Raw'], 'freqData', 'freqs');


freqData = RM_Pow_2Bin;
save([savePath 'RM_Pow_2Bin'], 'freqData', 'freqs');

freqData = RM_Pow_2BinOff1;
save([savePath 'RM_Pow_2BinOff1'], 'freqData', 'freqs');

freqData = RM_Pow_2BinOff2;
save([savePath 'RM_Pow_2BinOff2'], 'freqData', 'freqs');

freqData = RM_Pow_3Bin;
save([savePath 'RM_Pow_3Bin'], 'freqData', 'freqs');

freqData = RM_Pow_3BinOff1;
save([savePath 'RM_Pow_3BinOff1'], 'freqData', 'freqs');

freqData = RM_Pow_Raw;
save([savePath 'uncorrected/' 'RM_Pow_Raw'], 'freqData', 'freqs');


freqData = ChanAvg_Pow_2Bin;
save([savePath 'ChanAvg_Pow_2Bin'], 'freqData', 'freqs');

freqData = ChanAvg_Pow_2BinOff1;
save([savePath 'ChanAvg_Pow_2BinOff1'], 'freqData', 'freqs');

freqData = ChanAvg_Pow_2BinOff2;
save([savePath 'ChanAvg_Pow_2BinOff2'], 'freqData', 'freqs');

freqData = ChanAvg_Pow_3Bin;
save([savePath 'ChanAvg_Pow_3Bin'], 'freqData', 'freqs');

freqData = ChanAvg_Pow_3BinOff1;
save([savePath 'ChanAvg_Pow_3BinOff1'], 'freqData', 'freqs');

freqData = ChanAvg_Pow_Raw;
save([savePath 'uncorrected/' 'ChanAvg_Pow_Raw'], 'freqData', 'freqs');


topoData = ChanTopo_Pow_2Bin;
save([savePath 'topo/' 'ChanTopo_Pow_2Bin'], 'topoData', 'chanList');

topoData = ChanTopo_Pow_2BinOff1;
save([savePath 'topo/' 'ChanTopo_Pow_2BinOff1'], 'topoData', 'chanList');

topoData = ChanTopo_Pow_2BinOff2;
save([savePath 'topo/' 'ChanTopo_Pow_2BinOff2'], 'topoData', 'chanList');

topoData = ChanTopo_Pow_3Bin;
save([savePath 'topo/' 'ChanTopo_Pow_3Bin'], 'topoData', 'chanList');

topoData = ChanTopo_Pow_3BinOff1;
save([savePath 'topo/' 'ChanTopo_Pow_3BinOff1'], 'topoData', 'chanList');
