...
MotorClusters(1).sub = 'AVTapNoTap1'; %Musician
MotorClusters(2).sub = 'AVTapNoTap2'; %Musician
MotorClusters(3).sub = 'AVTapNoTap4'; %Musician
...
MotorClusters(9).sub = 'AVTapNoTap10'; %Musician
MotorClusters(10).sub = 'AVTapNoTap11'; %Musician
MotorClusters(11).sub = 'AVTapNoTap12';
MotorClusters(12).sub = 'AVTapNoTap13'; 
MotorClusters(13).sub = 'AVTapNoTap14'; %Musician
MotorClusters(14).sub = 'AVTapNoTap17';
MotorClusters(15).sub = 'AVTapNoTap18';
MotorClusters(16).sub = 'AVTapNoTap19';
MotorClusters(17).sub = 'AVTapNoTap20'; %Musician
MotorClusters(18).sub = 'AVTapNoTap21'; %Musician
...
% file paths
loadITCPath = '/Users/danielcomstock/Documents/Data/AV_TapNoTap/Data/07_Comp_TF_Data/f02ITC/';
loadPowerPath = '/Users/danielcomstock/Documents/Data/AV_TapNoTap/Data/07_Comp_TF_Data/f02tfPower/';
saveITCPath = '/Users/danielcomstock/Documents/Data/AV_TapNoTap/Data/07b_f02_tfStatsPlotData/ITC';
savePowerPath = '/Users/danielcomstock/Documents/Data/AV_TapNoTap/Data/07b_f02_tfStatsPlotData/Power';
