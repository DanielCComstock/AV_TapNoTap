...
splitTotalf0Pow(1:8,3) = musicGrandAvgf0PowData(:,2);
splitTotalf0Pow(1:8,5) = musicGrandAvgf0PowData(:,3);
splitTotalf0Pow(1:8,7) = musicGrandAvgf0PowData(:,4);
splitTotalf0Pow(1:10,2) = nonMusicGrandAvgf0PowData(:,1);
splitTotalf0Pow(1:10,4) = nonMusicGrandAvgf0PowData(:,2);
splitTotalf0Pow(1:10,6) = nonMusicGrandAvgf0PowData(:,3);
...
title('Grand Average Noise Corrected Power at f0', 'FontSize', 16, 'FontWeight','bold','FontName','Helvetica');
color = ['g','m','g','m','g','m','g','m'];
...
set(gca,'xtick',[1.5, 4.5, 8.5, 11.5], 'xticklabel',{'Aud Still', 'Aud Tap','Vis Still', 'Vis Tap'});
