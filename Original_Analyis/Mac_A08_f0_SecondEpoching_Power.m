...
savePath = '/Users/danielcomstock/Documents/Data/AV_TapNoTap/Data/07_Comp_TF_Data/f0tfPower/';
...
for fileIDX = 1:length(allFiles)
    ...
    for nCompsIDX = 1:length(TF_dataW.f0)
        ...
        % add epoched data to data file
         ...
         eTF_dataW.Data(nCompsIDX).tfPower = 10*log10(mean(abs(tfTrialData).^2,3));
