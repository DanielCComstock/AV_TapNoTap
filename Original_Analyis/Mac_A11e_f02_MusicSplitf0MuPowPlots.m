...
for typeIDX = 1:length(avgTypes)
    ...
    muscianCorrectedPlotData = neighborCorrectedData(:,musicianIDX,:);
    nonMusicianCorrectedPlotData = neighborCorrectedData(:,nonMusicanIDX,:);
    ...
    subplot(4,1,1);
    hold on
    plot(rawPlotFreqs,muscianPlotData(:,:,1),'-g', 'LineWidth', 1)
    plot(rawPlotFreqs,nonMusicianPlotData(:,:,1),'-r', 'LineWidth', 1)
    hold off
    ...
    subplot(4,1,2);
    hold on
    plot(rawPlotFreqs,muscianPlotData(:,:,2),'-g', 'LineWidth', 1)
    plot(rawPlotFreqs,nonMusicianPlotData(:,:,2),'-r', 'LineWidth', 1)
    hold off
    ...
    subplot(4,1,3);
    hold on
    plot(rawPlotFreqs,muscianPlotData(:,:,3),'-g', 'LineWidth', 1)
    plot(rawPlotFreqs,nonMusicianPlotData(:,:,3),'-r', 'LineWidth', 1)
    hold off
    ...
    subplot(4,1,4);
    hold on
    plot(rawPlotFreqs,muscianPlotData(:,:,4),'-g', 'LineWidth', 1)
    plot(rawPlotFreqs,nonMusicianPlotData(:,:,4),'-r', 'LineWidth', 1)
    hold off
    ...
    subplot(4,1,1);
    hold on
    plot(correctedFreqs,muscianCorrectedPlotData(:,:,1),'-g', 'LineWidth', 1)
    plot(correctedFreqs,nonMusicianCorrectedPlotData(:,:,1),'-r', 'LineWidth', 1)
    hold off
    title(char(lableNames(1)), 'FontSize', 10, 'FontWeight','bold');
    xlim([1.3 7]);
    ...
    subplot(4,1,2);
    hold on
    plot(correctedFreqs,muscianCorrectedPlotData(:,:,2),'-g', 'LineWidth', 1)
    plot(correctedFreqs,nonMusicianCorrectedPlotData(:,:,2),'-r', 'LineWidth', 1)
    hold off
    title(char(lableNames(2)), 'FontSize', 10, 'FontWeight','bold');
    xlim([1.3 7]);
    ...
    subplot(4,1,3);
    hold on
    plot(correctedFreqs,muscianCorrectedPlotData(:,:,3),'-g', 'LineWidth', 1)
    plot(correctedFreqs,nonMusicianCorrectedPlotData(:,:,3),'-r', 'LineWidth', 1)
    hold off
    title(char(lableNames(3)), 'FontSize', 10, 'FontWeight','bold');
    xlim([1.3 7]);
    ...
    subplot(4,1,4);
    hold on
    plot(correctedFreqs,muscianCorrectedPlotData(:,:,4),'-g', 'LineWidth', 1)
    plot(correctedFreqs,nonMusicianCorrectedPlotData(:,:,4),'-r', 'LineWidth', 1)
    hold off
    title(char(lableNames(4)), 'FontSize', 10, 'FontWeight','bold');
    xlim([1.3 7]);
