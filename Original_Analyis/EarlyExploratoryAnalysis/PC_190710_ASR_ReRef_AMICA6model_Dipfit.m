...
for j = 1:length(allFiles)
    ...
    EEG = clean_rawdata(EEG, 5, [-1], 0.8, -1, 20, 0.25);
    EEG = eeg_checkset( EEG );
    ...
    amicaoutputdir = ['H:\Data\AV_TapNoTap\03b_ASR_ReRef_AMICA1Model_Dipfit\AMICA_out\' savename];
    runamica15(EEG.data, 'num_chans', EEG.nbchan,...
        'outdir', amicaoutputdir,...
        'pcakeep', dataRank, 'num_models', 6, 'max_threads', 16, 'max_iter', 2000, ...
        'do_reject', 1, 'numrej', 10, 'rejsig', 3, 'rejint', 1);
